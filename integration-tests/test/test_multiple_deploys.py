...
def test_multiple_deploys_at_once(command_line_options: CommandLineOptions, docker_client: DockerClient) -> None:
    ...
    with conftest.testing_context(command_line_options, docker_client, bootstrap_keypair=BOOTSTRAP_NODE_KEYS, bonds_file_keypairs=bonds_file_keypairs) as context:
